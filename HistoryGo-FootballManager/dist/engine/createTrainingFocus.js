...
function intensityFromSeverity(severity) {
    if (severity === "high")
        return "high";
    if (severity === "medium")
        return "medium";
...
function areaFromCategory(category) {
    ...
    if (category === "midfield")
        return "midtbanekontroll";
    if (category === "attack")
        return "angrepsstruktur";
    if (category === "risk")
        return "risikobalanse";
    return "lagstruktur";
}
function sessionFromArea(area) {
...
function labelFromArea(area) {
    if (area === "rolleforståelse")
        return "Tren rolleforståelse.";
    if (area === "press")
        return "Tren press-sammenheng.";
    if (area === "bredde")
        return "Tren breddestruktur.";
    if (area === "restforsvar")
        return "Tren restforsvar og sikring.";
    if (area === "midtbanekontroll")
        return "Tren midtbanekontroll.";
    if (area === "angrepsstruktur")
        return "Tren angrepsstruktur.";
    if (area === "risikobalanse")
        return "Tren risikobalanse.";
    if (area === "fullføring")
        return "Fullfør lagoppsettet.";
    return "Tren lagstruktur.";
}
function focusCodeFromWeakPoint(weakPoint) {
    return `training_focus_${weakPoint.category}_${weakPoint.code}`;
}
function toTrainingFocusItem(weakPoint) {
...
function mergeFocusItems(items) {
...
function buildSummary(analysis, focusItems, setupScore) {
...
export function createTrainingFocus(evaluation) {
    ...
    return {
        ...
        weeklyPlan,
        summary: buildSummary(analysis, focusItems, evaluation.setupScore),
    };
}
