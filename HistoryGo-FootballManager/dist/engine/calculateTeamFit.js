...
import { calculatePlayerMatchFit, } from "./calculatePlayerMatchFit.js";
import { calculateRoleRelationships, } from "./calculateRoleRelationships.js";
import { applyBadgeEffectsToMetrics, buildEarnedBadgeEffectContext, calculateBadgeMetricEffects, } from "./calculateBadgeMetricEffects.js";
import { buildHistoricalFormationReport, calculateHistoricalFormationFit, } from "./calculateHistoricalFormationFit.js";
// ---------------------------------------------------------------------------
// Hjelpere
// ---------------------------------------------------------------------------
...
function isCompleteAssignment(assignment) {
...
// Sammenstilling
// ---------------------------------------------------------------------------
export function calculateTeamFit(input) {
    ...
    const historicalAssignments = completeAssignments.map((assignment) => ({
    ...
    const teamScore = clamp(Math.round(metrics.individualFitAverage * 0.26 +
