...
import { analyzeWeakPointsFromTeamFit } from "./analyzeWeakPointsFromTeamFit.js";
import { recommendRoleChangesFromTeamFit } from "./recommendRoleChangesFromTeamFit.js";
const MAX_TOP_ACTIONS = 5;
function buildSummary(teamFit, weakPoints) {
 ...
 * elleveren/headline.
 */
export function createTeamFitManagerInsight(teamFit, context) {
